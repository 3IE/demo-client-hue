...
namespace app.directive {
	...
	export class BabylonSurfaceNew implements ng.IDirective {
		...
		public static Factory() {
			const directive = (businessLight: engine.common.business.Light) => {
				return new BabylonSurfaceNew(businessLight);
			};
			return directive;
		};
	...
	angular.module('starterKit').directive('babylonSurfaceNew', ['business.light', BabylonSurfaceNew.Factory()]);
}
